//  main.cpp
//  Sudoku Solver And Sudoku Checker 
...
class SudokuFrame{
    ...
    {
        cout<<"\n==================================\n";
        cout<<" Sudoku Solver And Sudoku Checker\n";
        cout<<"==================================\n\n";

        cout<<"Welcome to the Sudoku Solver And Checker!\n";
    ...
    void readFrameValues()
    {
        ...
        for(row_val=0; row_val<9; row_val++){
            for(col_val=0; col_val<9; col_val++){
                ...
                if(value==0) 
                editableFrame[row_val][col_val]=0;
                else 
                editableFrame[row_val][col_val]=1;
            }
            cout<<"-------\n";
        }
    }
    ...
    {
        return editableFrame[row][col] == 0;                   // return (editableFrame[row][col]-1)*(-1)
    }
...
class Possibilities{
    ...
    public:int operator[](int index){                           // operator overloading
        int count=0;
        pos=head->next;
...
int main(){
    ...
    if(choice!=1 && choice!=2)
    {
            while(1){
                ...
                else if (choice==2) SudokuSolver::SudokuChecker s;
                else continue;
                break;
            }
